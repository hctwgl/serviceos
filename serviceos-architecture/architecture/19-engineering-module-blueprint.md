...
| files | shared-kernel、identity.api、authorization.api、audit.api、reliability.api、task.api/task.spi（隔离扫描任务） |
...
| forms | task.api、configuration.api、identity.api、authorization.api、audit.api、reliability.api |
