...
当前版本为 `0.24.0`。在 M22 guard 基线上，0.24.0 新增 PREPARED/ACTIVE/ABORTED 责任切换、旧责任原子撤销、Task 主体切换和冻结幂等事实。该版本仍不代表策略解析、Dispatch/ServiceAssignment/容量/完整改派 saga、SLA、网关、并行、等待或比亚迪勘安全流程已经完整实现，也不代表所有 Proposed 文档已获得业务与技术签署。
