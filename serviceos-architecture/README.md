...
当前版本为 `0.23.0`。在 M21 责任事实基线上，0.23.0 新增 TaskExecutionGuard、唯一 ACTIVE 保护窗、精确解除、幂等事实和人工命令失败关闭。该版本仍不代表策略解析、PREPARED TaskAssignment、ServiceAssignment/容量/改派 saga、SLA、网关、并行、等待或比亚迪勘安全流程已经完整实现，也不代表所有 Proposed 文档已获得业务与技术签署。
