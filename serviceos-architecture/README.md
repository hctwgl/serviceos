...
当前版本为 `0.18.0`。在 0.17.0 的 M16 入站基线上，0.18.0 新增 WorkOrderReceived Outbox、Inbox 幂等消费、精确 Workflow 版本启动，以及首个 Stage/Task 创建和 WorkOrder 激活。该版本仍不代表比亚迪勘安全流程或全部核心业务已经实现，也不代表所有 Proposed 文档已获得业务与技术签署。
