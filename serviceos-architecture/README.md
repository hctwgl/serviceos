...
当前版本为 `0.21.0`。在 M19 跨阶段与 END 基线上，0.21.0 新增人工工作流 Task 的 claim/start/complete、授权审计、幂等冻结响应、HTTP/OpenAPI 以及统一 TaskCompleted 推进。该版本仍不代表候选人 Assignment、SLA、网关、并行、等待或比亚迪勘安全流程已经完整实现，也不代表所有 Proposed 文档已获得业务与技术签署。
