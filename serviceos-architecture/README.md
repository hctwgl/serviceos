...
当前版本为 `0.22.0`。在 M20 人工命令基线上，0.22.0 新增 USER 候选快照、唯一 ACTIVE 责任、候选领取门禁、release/reclaim、责任有效期和 HTTP/OpenAPI。该版本仍不代表策略解析、ServiceAssignment/容量/改派 saga、Task guard、SLA、网关、并行、等待或比亚迪勘安全流程已经完整实现，也不代表所有 Proposed 文档已获得业务与技术签署。
