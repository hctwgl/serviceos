...
当前版本为 `0.10.0`，包含 M0–M7 架构、研发和多 Portal 产品基线、M8 首条可构建工程纵向切片，以及 M9 OIDC 主体、租户/capability 授权、拒绝审计、Inbox 和 Outbox worker 参考实现。它不代表 M6 E1、正式 IdP/Broker、所有车企、业务类型或页面已经实现。
