...
当前版本为 `0.20.0`。在 M18 线性推进基线上，0.20.0 新增唯一无条件跨阶段推进、END 完结，以及 Stage、Workflow、WorkOrder 的原子完成状态与稳定领域事件。该版本仍不代表网关、并行、等待、人工任务动作或比亚迪勘安全流程已经完整实现，也不代表所有 Proposed 文档已获得业务与技术签署。
