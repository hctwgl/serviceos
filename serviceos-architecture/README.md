...
当前版本为 `0.16.0`。在 0.15.0 的 M0–M14 架构、工程与部署基线上，0.16.0 新增统一领域语言、限界上下文地图、聚合目录和 ADR-020，冻结 WorkOrder、Task、Evidence、ReviewCase、ConfigurationBundle 等一级概念及事实源边界。该版本仍不代表全部核心业务已经实现，也不代表所有 Proposed 文档已获得业务与技术签署。
