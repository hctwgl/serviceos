...
当前版本为 `0.25.0`。在 M23 Task 侧握手基线上，0.25.0 新增 Dispatch ServiceAssignment、容量权威、切换前 abort、本地激活 saga 和冻结幂等事实。该版本仍不代表跨模块 Inbox 编排、派单策略、切换后补偿、SLA、网关、并行、等待或比亚迪勘安全流程已经完整实现，也不代表所有 Proposed 文档已获得业务与技术签署。
