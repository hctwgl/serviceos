...
23. [授权与审计逻辑数据模型](data/02-authorization-audit-logical-model.md)
24. [M2 执行内核验收矩阵](testing/01-m2-execution-acceptance-matrix.md)
25. [M3 现场作业验收矩阵](testing/02-m3-field-operations-acceptance-matrix.md)
26. [M4 自动化验收矩阵](testing/03-m4-automation-integration-acceptance.md)
27. [MVP 与实施路线](roadmap/00-mvp-roadmap.md)
28. [已确认业务事实](research/00-confirmed-business-facts.md)
29. [M1 业务资产基线填写手册](research/01-m1-business-asset-pack.md)
30. [术语表](docs/glossary.md)
...
当前版本为 `0.5.0`，包含架构基线、M1 业务资产模板、M2 履约内核、M3 现场作业，以及 M4 派单、SLA、车企集成、通知和人工异常闭环。它不是完整 PRD，也不直接承诺微服务数量、数据库表数量或具体中间件。
