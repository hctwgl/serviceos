...
当前版本为 `0.17.0`。在 0.16.0 统一领域语言基线上，0.17.0 新增 M16 最小配置资产/Bundle 发布解析、工单 tenant/project/bundle 权威引用，以及 BYD CPIM HTTP 到工单创建的事务切片。该版本仍不代表比亚迪勘安全流程或全部核心业务已经实现，也不代表所有 Proposed 文档已获得业务与技术签署。
