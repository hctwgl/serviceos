...
34. [MVP 与实施路线](roadmap/00-mvp-roadmap.md)
35. [已确认业务事实](research/00-confirmed-business-facts.md)
36. [M1 业务资产基线填写手册](research/01-m1-business-asset-pack.md)
37. [术语表](docs/glossary.md)
...
当前版本为 `0.6.0`，包含 M0–M5 架构基线：业务资产、履约内核、现场作业、自动化闭环、双向试算、迁移灰度与试点上线。它不是完整 PRD，也不直接承诺微服务数量、数据库表数量或具体中间件。
