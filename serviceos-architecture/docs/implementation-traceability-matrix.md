...
| M41 | 无 formRef 资料 Task 完成仅接受精确 EvidenceSetSnapshot 引用与 digest | OpenAPI 0.16.0 + Evidence/HumanTask PostgreSQL IT + Modulith | 表单+资料双引用 inputVersionRefs、Review/Correction |
