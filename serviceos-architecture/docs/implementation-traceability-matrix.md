...
| M154 | Admin 工作区 AV/FE → Task 旁路深链；Playwright 预约确认与表单 VALIDATED 后 GET 200 | PRODUCT-01/02 + ARCH-19 + OpenAPI workspace sections + Admin Web E2E + `167-m154-*` + `151-m154-*` | Appointment/Visit/Form/Evidence 独立详情页、专用入站队列列表 API、SavedView、真实 sandbox |
