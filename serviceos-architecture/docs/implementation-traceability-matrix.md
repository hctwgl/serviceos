...
| M137 | Admin BYD 提审外发 ACK E2E：USER 可提交、Canonical 系谱夹具、本地 stub errno=0→ACKNOWLEDGED+CLIENT Case；OpenAPI 0.71.0 | PRODUCT-01/02 + ARCH-13/19 + OutboundDelivery APIs + Admin Web build/E2E + `150-m137-*` + `134-m137-*` | 真实 sandbox、厂端回调浏览器联调、其他 CPIM、人工标记已送达/放弃 |
