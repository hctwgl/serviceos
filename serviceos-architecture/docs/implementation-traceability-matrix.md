...
| project | ARCH-01/03/05、M64 | API-07、OpenAPI Core 0.35.0、project.created@v2 | DATA-01、V064 | M2 CFG/WO、M7 ADM、M64 | E0/E2 |
| authorization | ARCH-07、ARCH-21、M63～M64 | API-01/02、ProjectRegionScopeResolver | DATA-02、V064 | M2 AUTH、M6 SEC、M63～M64 | E1/E4 |
...
| sla | ARCH-12、M61～M64 | sla.started/breached/met@v1；API-04、OpenAPI Core 0.35.0 | DATA-04、V061～V064 | M4 SLA、M61～M64 | E4 |
