...
| M173 | Admin 详情页源资源明文字段深链：Outbound/Receipt/Exception/Review 事实格 UUID；Playwright GET 200 | PRODUCT-01/02 + ARCH-19 + Core OpenAPI + Admin Web E2E + `186-m173-*` + `170-m173-*` | ReviewRoute、FieldOperation、SavedView、真实 sandbox |
