...
| M157 | Admin 工作区项目与 SLA 任务深链；Playwright Project/Task GET 200 | PRODUCT-01/02 + ARCH-19 + OpenAPI Project/Task/SLA GET + Admin Web E2E + `170-m157-*` + `154-m157-*` | Visit 详情、专用入站队列列表 API、SavedView、企业 OIDC、真实 sandbox |
