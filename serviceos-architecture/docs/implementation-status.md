...
baselineCommit: b86ae6cb79af12ab418c331ed67b657b2977bd6d
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M306 DISPATCH 运行时 |
| 基线提交 | `b86ae6cb79af12ab418c331ed67b657b2977bd6d`（功能证据提交后回填；合入 `master` 后改为合并提交） |
...
| 配置中心 | 不可变配置资产、Bundle 发布、设计器与灰度通道 | `PARTIAL` | M282～M296 设计器/治理 + **M303～M306** INTEGRATION/ASSIGNEE/DISPATCH 运行时 | 条件积木、NOTIFICATION/RULE/PRICING 运行时、出站 Mapping | M16、M33、M36、M52～M53、M61、M268、M271、M281～M296、M303～M306 |
...
下一主线（已批准）：P2 配置资产运行时（NOTIFICATION → RULE → PRICING）→ 业务低代码设计器 →
