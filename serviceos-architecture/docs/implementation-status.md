...
baselineCommit: 5875a23674bf649d9d00549c3407cef825bca37b
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M307 NOTIFICATION 运行时 |
| 基线提交 | `5875a23674bf649d9d00549c3407cef825bca37b`（功能证据提交后回填；合入 `master` 后改为合并提交） |
...
| 配置中心 | 不可变配置资产、Bundle 发布、设计器与灰度通道 | `PARTIAL` | M282～M296 设计器/治理 + **M303～M307** INTEGRATION/ASSIGNEE/DISPATCH/NOTIFICATION 运行时 | 条件积木、RULE/PRICING 运行时、出站 Mapping、真实短信/邮件 Adapter | M16、M33、M36、M52～M53、M61、M268、M271、M281～M296、M303～M307 |
...
下一主线（已批准）：P2 配置资产运行时（RULE → PRICING）→ 业务低代码设计器 →
