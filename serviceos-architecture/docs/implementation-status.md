...
baselineCommit: 8d99cc546128c7524914ece06b9b29a929e65a4a
latestMilestone: M309
---
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M309 PRICING 运行时 |
| 基线提交 | `8d99cc546128c7524914ece06b9b29a929e65a4a`（功能证据提交后回填；合入 `master` 后改为合并提交） |
...
| 配置中心 | 不可变配置资产、Bundle 发布、设计器与灰度通道 | `PARTIAL` | M282～M296 设计器/治理 + **M303～M309** 六类资产运行时（INTEGRATION/ASSIGNEE/DISPATCH/NOTIFICATION/RULE/PRICING） | 条件积木、出站 Mapping、真实短信/邮件 Adapter、结算落账 | M16、M33、M36、M52～M53、M61、M268、M271、M281～M296、M303～M309 |
...
下一主线（已批准）：P3 业务低代码设计器增强 → P4 第二 OEM（Geely；缺材料则 BLOCKED_EXTERNAL）→
