...
baselineCommit: "8dca2a09ca6d9218218a680fdbcc57d2c4a16d06"
...
| 基线提交 | `8dca2a09ca6d9218218a680fdbcc57d2c4a16d06`（功能提交后回填） |
...
M321～M342 均在 Draft stacked PRs 中（`#148→…→#169`；本切片 https://github.com/hctwgl/serviceos/pull/169）；M320 已合入 `master`（`32b902f8`）。
