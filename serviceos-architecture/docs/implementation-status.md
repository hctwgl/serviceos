...
baselineCommit: 80612182f5bec4889b23ff27d08d7551a49ef52c
latestMilestone: M308
---
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M308 RULE 运行时 |
| 基线提交 | `80612182f5bec4889b23ff27d08d7551a49ef52c`（功能证据提交后回填；合入 `master` 后改为合并提交） |
...
| 配置中心 | 不可变配置资产、Bundle 发布、设计器与灰度通道 | `PARTIAL` | M282～M296 设计器/治理 + **M303～M308** INTEGRATION/ASSIGNEE/DISPATCH/NOTIFICATION/RULE 运行时 | 条件积木、PRICING 运行时、出站 Mapping、真实短信/邮件 Adapter | M16、M33、M36、M52～M53、M61、M268、M271、M281～M296、M303～M308 |
...
下一主线（已批准）：P2 配置资产运行时（PRICING）→ 业务低代码设计器 →
