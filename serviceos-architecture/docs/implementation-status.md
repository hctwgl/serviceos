...
baselineCommit: 121cc7d3ed97f2354bb0fb9e7f0029be8be5e271
latestMilestone: M208
---
...
ServiceOS 可靠纵向切片已推进到 **M208**。身份治理 M183～M188、Admin 个人/共享 SavedView、Admin UI
...
enrichment 计数、Network Portal 产能页（`NETWORK.CAPACITY`）已交付。没有实现
`search_document` 索引平台、VEHICLE/CHARGER 搜索、共享 UI Preference、notifications、Consumer
Identity、正式 HR Connector、ORGANIZATION DataScope、槽位 allowOnBehalf 配置表、Portal
