...
| 契约 | Core OpenAPI **1.0.72** + BYD CPIM OpenAPI 0.3.0 + 外部/事件 JSON Schema（含 `/project-clients`、`/region-catalog`、`change-timeline`、`org-memberships`、`recent-logins`、用户目录与关注项目等既有契约） |
