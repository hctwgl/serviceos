...
baselineCommit: "PENDING_M346_FEATURE_COMMIT"
...
| 基线提交 | `PENDING_M346_FEATURE_COMMIT`（功能提交后回填） |
...
M321～M346 均在 Draft stacked PRs 中（`#148→…→#172→本切片`）；M320 已合入 `master`（`32b902f8`）。
