...
| Admin Portal | 总部运营后台 | `PARTIAL` | **M284/M287/M289/M291/M292/M294/M295/M296** 配置设计器；M101～M193 运营基线；**M328** UNKNOWN；**M351** 终审；**M370～M377** 设计系统；**M384～M389** 配置四核与工单详情；**M397** 用户管理；**M398～M400** 项目管理、方案聚合与实体选择器（`READY_FOR_REVIEW`） | 关注项目读模型、行政区名称树/车企主数据、新建用户写流程、正式企业 OIDC/BFF；不得宣称 PRODUCT_ACCEPTED | M7 设计、M101～M193、M284～M296、M328、M351、M370～M377、M384～M389、M397～M400、Admin 试点基线 |
