...
baselineCommit: 5a5a673158422f55dd75cebbaa4ede39abdd60e0
latestMilestone: M312
---
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M312 Workflow 画布属性面板与撤销重做 |
| 基线提交 | `5a5a673158422f55dd75cebbaa4ede39abdd60e0`（功能证据提交后回填；合入 `master` 后改为合并提交） |
...
| 配置中心 | 不可变配置资产、Bundle 发布、设计器与灰度通道 | `PARTIAL` | M282～M296 设计器/治理 + **M303～M309** 六类运行时 + **M310～M312** 条件积木/画布属性面板 | FORM/EVIDENCE/SLA 可视配置器、嵌套表达式 round-trip、出站 Mapping、真实短信/邮件 Adapter、结算落账 | M16、M33、M36、M52～M53、M61、M268、M271、M281～M296、M303～M312 |
...
下一主线（已批准）：P3 续 FORM/EVIDENCE/SLA 可视配置器；P4 吉利 7.2+ / Sandbox（BLOCKED_EXTERNAL）→
