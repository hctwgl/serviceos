...
baselineCommit: PENDING_M124
latestMilestone: M124
---
...
| Admin Portal | 总部运营后台 | `PARTIAL` | M101～M124：队列/任务/SLA/异常/外发/工单/项目目录、工作区、allowed-actions 命令面板 | 设计系统、SavedView、OIDC SDK、E2E、完整表单/资料提交流程 | M7 设计、M101～M124 |
...
ServiceOS 可靠纵向切片已推进到 **M124**。M61～M124 在授权只读、时间线投影运行时、工作区组合与
