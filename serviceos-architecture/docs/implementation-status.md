...
baselineCommit: "d76c26dd9f024eba51d049f0b45660ce3ec015cc"
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M329 RULE CLIENT 外部回执门禁 |
| 基线提交 | `d76c26dd9f024eba51d049f0b45660ce3ec015cc`（功能证据；合入 `master` 后改为合并提交） |
...
| 配置中心 | 不可变配置资产、Bundle 发布、设计器与灰度通道 | `PARTIAL` | M282～M296 设计器/治理 + **M303～M309** 六类运行时 + **M310～M315** 设计器 + **M321～M329** 配置驱动履约主链路（Mapping / ASSIGNEE / DISPATCH / RULE INTERNAL+CLIENT / NOTIFICATION / PRICING SHADOW / Admin UNKNOWN·Replay） | 全量字段仅 Mapping、删除 Profile 硬编码、默认值/枚举/条件 DSL、Evidence finalize / Task complete RULE 门禁、嵌套表达式、DISPATCH TECHNICIAN/地图、BUSINESS 日历 SLA、结算落账、低代码深化 | M16、M33、M36、M52～M53、M61、M268、M271、M281～M296、M303～M315、M321～M329 |
