...
baselineCommit: 6b0e3d338ad445db73529c84aa01d04a2980d318
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M281 标准维修/移机/巡检配置模板 |
| 基线提交 | `6b0e3d338ad445db73529c84aa01d04a2980d318`（功能证据；合并入 `master` 后改为合并提交） |
...
| 数据库 | PostgreSQL + Flyway（当前版本 109 / 111） |
...
| 配置中心 | 不可变配置资产、Bundle 发布和版本锁定 | `PARTIAL` | FORM、EVIDENCE、SLA v1；表达式子集；依赖闭包；Workflow 条件静态门禁；**M271** 家充勘安模板；**M281** 维修/移机/巡检标准模板 | 决策表/公式/脚本、完整审批 UI、通用依赖图、完整 FORM/EVIDENCE 模板包、设计器 | M16、M33、M36、M52～M53、M61、M268、M271、M281 |
...
ServiceOS 可靠纵向切片已推进到 **M281**。阶段一已闭合；复杂流程运行时已覆盖 EXCLUSIVE、PARALLEL、
WAIT_EVENT、TIMER、SUB_PROCESS、多实例、取消/重开/跳转，取消时配置化补偿任务（Flyway V109），以及 **维修/移机/巡检标准模板**。
