...
baselineCommit: f51b7cebd02c508430c1a760b72eeb08abaab018
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M319 批量 ReplayRequest 预演与审批 |
| 基线提交 | `f51b7cebd02c508430c1a760b72eeb08abaab018`（功能证据提交后回填；合入 `master` 后改为合并提交） |
...
| 外部接入 | BYD CPIM + REFERENCE_OEM SAMPLE + Geely 本地切片 | `PARTIAL` | BYD 入站建单/更新/取消、提审、回调；**M267/M297～M302** 通用 SPI（建单、更新、取消、出站、回调、Profile/Route）；**M311/M314/M316** 吉利本地生命周期 + **M317～M319** 远端查询/人工处置/批量重放 | 吉利 Sandbox/OpenAPI 签名联调（BLOCKED_EXTERNAL）、Sandbox/签名、其余 7.x、生产凭据/对象存储 | M16、M56～M60、M77～M79、M99、M158、M267、M272、M311、M314、M316、M317、M318、M319、M273、M297～M302 |
