...
baselineCommit: "4410b11df19839fd9050bd0cc7e6341c7ad71879"
...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M339 UPDATE/CANCEL 强制 INBOUND Mapping |
| 基线提交 | `4410b11df19839fd9050bd0cc7e6341c7ad71879`（功能提交后回填） |
...
| 配置中心 | 不可变配置资产、Bundle 发布、设计器与灰度通道 | `PARTIAL` | M282～M296 设计器/治理 + **M303～M309** 六类运行时 + **M310～M315** 设计器 + **M321～M339** 配置驱动履约主链路（含 Mapping DSL/强制/RouteHint + UPDATE/CANCEL Mapping + DISPATCH NETWORK/TECHNICIAN + Coverage 地图 + 比例缺口） | 嵌套表达式、AMOUNT/加权比例口径、BUSINESS 日历 SLA、结算落账、低代码深化 | M16、M33、M36、M52～M53、M61、M268、M271、M281～M296、M303～M315、M321～M339 |
