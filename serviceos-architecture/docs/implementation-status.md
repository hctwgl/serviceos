...
| 项目 | 当前值 |
|---|---|
| 最新实施里程碑 | M409 Admin 关注项目待办/SLA 角标聚合 |
...
| 契约 | Core OpenAPI **1.0.75** + BYD CPIM OpenAPI 0.3.0 + 外部/事件 JSON Schema（含关注项目角标、`/project-clients`、`/region-catalog`、`change-timeline`、`org-memberships`、`recent-logins`、用户目录等既有契约） |
