...
- 一级菜单：工作台、工单运营、服务履约、审核与整改、客户与项目、组织与资源、系统管理、审计与监控。
...
- 项目详情内的履约配置工作区、工作流设计器和工单详情的概念效果方向已经批准，后续实现必须遵守 [经典专业风视觉与页面基线](12-classic-professional-visual-baseline.md)。当前阶段不设置一级“配置中心”，不建设跨项目公共模板库。
