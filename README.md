...
当前工程基线推进至 **M115**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M115 084 86
```
...
[M115 Admin SLA 实例详情](serviceos-architecture/architecture/128-m115-admin-sla-instance-detail.md)。
