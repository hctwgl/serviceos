...
当前工程基线推进至 **M309**：在 M267～M306 之上，已交付出站提审/入站审核回调 SPI、Update/Cancel 入站 SPI，
...
弱网/后台/离线闭环、签名真机、真实 IdP、VoiceOver 与 TestFlight 尚未验收。下一主线为业务低代码设计器增强（P3）与第二 OEM（P4）；Track F/G 与真实 OEM Sandbox/凭据仍为 `BLOCKED_EXTERNAL` 并如实登记，
不阻塞通用能力推进。
