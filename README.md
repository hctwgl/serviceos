...
这只是 M8～M24 的工程参考切片。M24 完成 Dispatch 侧 ServiceAssignment、容量与本地激活 saga，但尚未接通跨模块 Inbox 编排；不代表 M6 Foundation 全部 P0、正式 IdP/Broker/对象存储/反病毒服务、策略解析、完整改派 saga、SLA、网关/并行或完整业务履约链路已经实现。
