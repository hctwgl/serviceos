...
当前工程基线推进至 **M103**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M103 084 86
```
...
[M103 Admin 工作区 allowed-actions 只读投影](serviceos-architecture/architecture/116-m103-admin-workspace-allowed-actions.md)。
