...
当前工程基线推进至 **M133**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M133 084 86
```
...
[M133 Admin 表单资料详情与文件作废](serviceos-architecture/architecture/146-m133-admin-evidence-form-detail-and-file-invalidate.md)。
