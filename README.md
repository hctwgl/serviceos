...
当前工程基线推进至 **M97**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M97 081 83
```
...
[M97 授权审核案例队列](serviceos-architecture/architecture/110-m97-authorized-review-case-queue.md)。
