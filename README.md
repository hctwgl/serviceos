...
当前工程基线推进至 **M338 DISPATCH 签约比例缺口评分**（https://github.com/hctwgl/serviceos/pull/165；栈 `#148→…→#165`）
PREVIEW/SUBMIT/审批。M337 Coverage 地图；M336 RouteHint；M335 CREATE 强制 Mapping；M334 DSL；
M333 无 fallback；M332 TECHNICIAN；M331 出站仅 Mapping；M327～M321 已交付 PRICING/通知/RULE/DISPATCH/ASSIGNEE 与 Mapping。
...
下一主线：吉利真实 Sandbox/凭据到位后优先联调；否则继续 Update/Cancel Mapping 与低代码深化。
