...
当前工程基线推进至 **M118**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M118 084 86
```
...
[M118 Admin BYD 提审外发创建](serviceos-architecture/architecture/131-m118-admin-byd-review-submission.md)。
