...
当前工程基线推进至 **M100**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M100 084 86
```
...
[M100 运营异常项目范围硬化](serviceos-architecture/architecture/113-m100-operational-exception-project-scope.md)。
