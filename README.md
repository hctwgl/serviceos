...
当前工程基线推进至 **M124**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M124 084 86
```
...
[M124 Admin 上门签到签退](serviceos-architecture/architecture/137-m124-admin-visit-checkin-checkout.md)。
