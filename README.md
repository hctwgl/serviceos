...
当前工程基线推进至 **M277**：在 M267 通用 Connector SPI / BYD 入站归位之上，已交付 Workflow
...
尚未验收。下一主线为多实例任务、撤回/取消/重开与领域配置设计器。
