...
当前工程基线推进至 **M96**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M96 080 82
```
...
[M96 工单工作区审核血缘元数据](serviceos-architecture/architecture/109-m96-work-order-workspace-review-lineage.md)。
