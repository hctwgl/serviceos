...
当前工程基线推进至 **M150**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
[M150 Admin 运营异常队列筛选](serviceos-architecture/architecture/163-m150-admin-operational-exception-queue-filters.md)。
