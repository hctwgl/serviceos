...
当前工程基线推进至 **M127**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M127 084 86
```
...
[M127 Admin 资料下载授权与 Revision 作废](serviceos-architecture/architecture/140-m127-admin-file-download-and-invalidate.md)。
