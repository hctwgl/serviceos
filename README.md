...
这只是 M8～M20 的工程参考切片。M20 只完成授权人工工作流 Task 的基础动作，不代表 M6 Foundation 全部 P0、正式 IdP/Broker/对象存储/反病毒服务、候选人 Assignment、SLA、网关/并行或完整业务履约链路已经实现。
