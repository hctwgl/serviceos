...
当前工程基线推进至 **M72**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M72 070 72
```
...
[M72 Task 执行 Attempt 历史查询](serviceos-architecture/architecture/85-m72-task-execution-attempt-history.md)。
