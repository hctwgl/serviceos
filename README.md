...
当前工程基线推进至 **M336 CREATE_WORK_ORDER RouteHint**（https://github.com/hctwgl/serviceos/pull/163；栈 `#148→…→#163`）
PREVIEW/SUBMIT/审批。M335 CREATE 强制 Mapping；M334 DSL；M333 无 fallback；M332 TECHNICIAN；
...
下一主线：吉利真实 Sandbox/凭据到位后优先联调；否则继续 DISPATCH 地图/比例与低代码深化。
