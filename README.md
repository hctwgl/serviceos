...
当前工程基线推进至 **M63**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M63 063 65
```
...
[M63 授权项目集合与跨项目 SLA 队列](serviceos-architecture/architecture/76-m63-authorized-project-scope-sla-queue.md)。
