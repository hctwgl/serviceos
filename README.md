...
当前工程基线推进至 **M337 DISPATCH 地图 scope / ServiceCoverage**（https://github.com/hctwgl/serviceos/pull/164；栈 `#148→…→#164`）
PREVIEW/SUBMIT/审批。M336 RouteHint；M335 CREATE 强制 Mapping；M334 DSL；M333 无 fallback；
M332 TECHNICIAN；M331 出站仅 Mapping；M327～M321 已交付 PRICING/通知/RULE/DISPATCH/ASSIGNEE 与 Mapping。
...
下一主线：吉利真实 Sandbox/凭据到位后优先联调；否则继续 DISPATCH 比例分配与低代码深化。
