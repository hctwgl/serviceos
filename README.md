...
当前工程基线推进至 **M290**：在 M267～M280 多 OEM 内核与复杂流程运行时之上，已交付工单取消级联、
授权重开、人工跳转、取消补偿，家充勘安/维修/移机/巡检标准模板，WORKFLOW/FORM/EVIDENCE/SLA 配置设计器 API，Admin 配置设计器壳，Diff/审批门禁，Bundle CANARY/回滚，Workflow 拖拽画布，CANARY 百分比流量灰度，画布建边/网关条件编辑，以及多槽位 CANARY 自动晋级。Track A、独立
...
弱网/后台/离线闭环、签名真机、真实 IdP、VoiceOver 与 TestFlight 尚未验收。下一主线为 Track F/G（外部阻塞项如实登记）。
