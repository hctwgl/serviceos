...
当前工程基线推进至 **M101**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M101 084 86
```
...
[M101 Admin Portal 队列外壳](serviceos-architecture/architecture/114-m101-admin-portal-queue-shell.md)。
