...
当前工程基线推进至 **M56**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
[M56 BYD CPIM InboundEnvelope 与 CanonicalMessage 权威入站事实](serviceos-architecture/architecture/69-m56-inbound-envelope-canonical-message-runtime.md)。
