...
当前工程基线推进至 **M95**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M95 080 82
```
...
[M95 工单工作区表单提交与资料项安全元数据](serviceos-architecture/architecture/108-m95-work-order-workspace-forms-evidence-metadata.md)。
