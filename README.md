...
当前工程基线推进至 **M66**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M66 066 68
```
...
[M66 项目范围关系整组修订](serviceos-architecture/architecture/79-m66-project-scope-relation-revision.md)。
