...
当前工程基线推进至 **M341 EVIDENCE requiredWhen 条件积木嵌入**（https://github.com/hctwgl/serviceos/pull/168；栈 `#148→…→#168`）。
M340 FORM ConditionBuilder；M339 UPDATE/CANCEL Mapping；M338 比例缺口；M337 Coverage；
...
下一主线：吉利真实 Sandbox/凭据到位后优先联调；否则继续嵌套表达式 round-trip 等低代码深化。
