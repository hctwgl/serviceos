...
当前工程基线推进至 **M92**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M92 080 82
```
...
[M92 工单工作区服务责任摘要](serviceos-architecture/architecture/105-m92-work-order-workspace-service-assignment.md)。
