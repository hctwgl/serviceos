...
当前工程基线推进至 **M93**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M93 080 82
```
...
[M93 工单最近活动摘要](serviceos-architecture/architecture/106-m93-work-order-activity-summary.md)。
