...
当前工程基线推进至 **M268**：在 M267 通用 Connector SPI / BYD 入站归位之上，已交付 Workflow
...
尚未验收。下一主线为 EXCLUSIVE_GATEWAY 运行时与 REFERENCE_OEM（见 `roadmap/06`）。
