...
当前工程基线推进至 **M108**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M108 084 86
```
...
[M108 Admin 授权项目目录](serviceos-architecture/architecture/121-m108-admin-project-directory.md)。
