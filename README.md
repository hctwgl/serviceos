...
- `shared`、`bootstrap`、`identity`、`authorization`、`project`、`audit`、`reliability`、`task`、`operations` 九个参考模块；
...
这只是 M8～M10 的工程参考切片，不代表 M6 全部 E1 门禁、正式 IdP/Broker 或业务履约链路已经实现。
