...
当前工程基线推进至 **M104**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M104 084 86
```
...
[M104 Admin 授权工单目录](serviceos-architecture/architecture/117-m104-admin-work-order-directory.md)。
