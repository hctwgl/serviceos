...
当前工程基线推进至 **M121**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M121 084 86
```
...
[M121 Admin 从资料快照创建审核案例](serviceos-architecture/architecture/134-m121-admin-create-review-case.md)。
