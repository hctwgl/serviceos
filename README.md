...
- OpenAPI 3.1 破坏性变更门禁、不可变事件 Schema 治理，以及可重复生成、编译、打包并由独立消费者安装的 TypeScript Client；
...
当前工程基线推进至 **M247**，但仍是模块化后端与多端共享基础纵向切片，不代表完整现场履约平台已经交付。
