...
当前工程基线推进至 **M130**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M130 084 86
```
...
[M130 Admin 分配任务候选](serviceos-architecture/architecture/143-m130-admin-assign-task-candidates.md)。
