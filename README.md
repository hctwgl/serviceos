...
当前工程基线推进至 **M281**：在 M267～M280 多 OEM 内核与复杂流程运行时之上，已交付工单取消级联、
授权重开、人工跳转、取消补偿，以及家充勘安/维修/移机/巡检平台中立标准模板。Track A、独立
...
弱网/后台/离线闭环、签名真机、真实 IdP、VoiceOver 与 TestFlight 尚未验收。下一主线为阶段三领域
配置设计器。
