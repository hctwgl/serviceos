...
当前工程基线推进至 **M292**：在 M267～M280 多 OEM 内核与复杂流程运行时之上，已交付工单取消级联、
授权重开、人工跳转、取消补偿，家充勘安/维修/移机/巡检标准模板，WORKFLOW/FORM/EVIDENCE/SLA 配置设计器 API，Admin 配置设计器壳，Diff/审批门禁，Bundle CANARY/回滚，Workflow 拖拽画布，CANARY 百分比流量灰度，画布建边/网关条件编辑，多槽位 CANARY 自动晋级，WORKFLOW 配置依赖分析，以及 WORKFLOW 干跑模拟。Track A、独立
