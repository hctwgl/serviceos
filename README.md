...
当前工程基线推进至 **M147**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
[M147 Admin 工作区外发交付详情深链](serviceos-architecture/architecture/160-m147-admin-workspace-outbound-delivery-deeplink.md)。
