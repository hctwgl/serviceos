...
- `shared`、`bootstrap`、`identity`、`authorization`、`project`、`configuration`、`audit`、`reliability`、`task`、`operations`、`files`、`integration`、`workorder` 十三个参考模块；
...
这只是 M8～M16 的工程参考切片。M16 把首个 BYD 入站请求接到配置锁定和工单创建，但不代表 M6 Foundation 全部 P0、正式 IdP/Broker/对象存储/反病毒服务、生产部署平台、Stage/Task/Workflow 或业务履约链路已经实现。
