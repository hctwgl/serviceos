...
当前工程基线推进至 **M342 嵌套条件组 round-trip**（https://github.com/hctwgl/serviceos/pull/169；栈 `#148→…→#169`）。
M341 EVIDENCE requiredWhen；M340 FORM ConditionBuilder；M339 UPDATE/CANCEL Mapping；M338 比例缺口；
...
下一主线：吉利真实 Sandbox/凭据到位后优先联调；否则继续 REFERENCE_OEM Update/Cancel 或 AMOUNT/加权等深化。
