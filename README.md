...
当前工程基线推进至 **M67**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M67 067 69
```
...
[M67 项目授权目录与范围历史查询](serviceos-architecture/architecture/80-m67-authorized-project-directory-query.md)。
