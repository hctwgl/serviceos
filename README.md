...
当前工程基线推进至 **M144**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
[M144 Admin 人工初派 ServiceAssignment HTTP](serviceos-architecture/architecture/157-m144-admin-manual-service-assignment-http.md)。
