...
当前工程基线推进至 **M65**，但仍是模块化后端纵向切片，不代表完整现场履约平台已经交付。
...
```bash
bash scripts/check-milestone-consistency.sh M65 065 67
```
...
[M65 项目网点关系与 NETWORK SLA 队列](serviceos-architecture/architecture/78-m65-project-network-scope-sla-queue.md)。
