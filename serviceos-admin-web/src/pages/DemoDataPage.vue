...
const accounts = [
  ...
  },
  {
    ...
    role: '网点调度',
    org: '济南恒通新能源服务中心（演示）',
    actions: '确认接单、指派师傅、联系/预约、代补资料与快照重提',
  },
  {
    portal: '师傅端',
    ...
    actions: '签到、表单/资料提交、完成任务（联系/预约在网点端）',
  },
]

/** 与 seed-demo-tasks.sql 一一对应；客户名形如「王先生·待网点接单」 */
const scenarios = [
  { code: '001', label: '待初审', hint: '无网点责任 → 工作区「初审通过：派给服务网点」' },
  { code: '002', label: '待分配网点', hint: '任务 READY，待平台派网点' },
  { code: '003', label: '网点待接单', hint: '无 ACTIVE 网点责任；也可 Admin 派网点后列表可见' },
  { code: '004', label: '待指派师傅', hint: '已有网点责任，无师傅责任' },
  { code: '005', label: '待联系客户', hint: '网点+张师傅已指派，任务 READY' },
  { code: '006', label: '待预约', hint: '任务 CLAIMED' },
  { code: '007', label: '待上门', hint: 'CONFIRMED 勘测预约已种子；网点可联系/改约' },
  { code: '008', label: '勘测中', hint: '任务 RUNNING + CONFIRMED 预约；师傅可签到/交资料/complete' },
  { code: '009', label: '待审核勘测资料', hint: 'OPEN 审核单已种子 → 管理端可驳回开整改' },
  { code: '010', label: '待安装', hint: '安装阶段 READY' },
  { code: '011', label: '安装中', hint: '安装阶段 RUNNING' },
  { code: '012', label: '待提交完工资料', hint: '安装阶段 RUNNING' },
  { code: '013', label: '待审核完工资料', hint: 'OPEN 审核单已种子 → 管理端可驳回开整改' },
  { code: '014', label: '整改中', hint: 'CORRECTION 阶段投影；真实整改单由 009/013 驳回产生' },
