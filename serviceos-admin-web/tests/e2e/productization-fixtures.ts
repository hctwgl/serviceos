          ...
          : [
              {
                ...
                currentTaskType: 'SITE_SURVEY',
                currentTaskStatus: 'RUNNING',
                currentClaimedBy: 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa',
                currentAssigneeDisplayName: '演示师傅',
                currentNetworkId: 'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb',
                currentNetworkDisplayName: '杭州西湖网点',
                currentTechnicianId: 'cccccccc-cccc-4ccc-8ccc-cccccccccccc',
                currentTechnicianDisplayName: '现场师傅甲',
              },
            ],
        nextCursor: null,
        asOf: '2026-07-20T04:00:00Z',
      ...
      await fulfillJson(route, {
        items: [
          ...
          },
          {
            ...
            actorDisplayName: '审批运营',
            result: 'SUCCEEDED',
            correlationId: 'corr-technician-membership',
            principalVersion: 1,
            occurredAt: '2026-07-20T03:50:00Z',
