...
export const serviceOsMenus: MenuRecordRaw[] = [
  ...
  { name: '审核与整改', path: '/work-orders?view=review', icon: 'lucide:clipboard-check', order: 30 },
  {
    name: '客户与项目',
    path: '/projects',
  ...
  { name: '审计与监控', path: '/work-orders?view=audit', icon: 'lucide:chart-no-axes-combined', order: 70 },
]
