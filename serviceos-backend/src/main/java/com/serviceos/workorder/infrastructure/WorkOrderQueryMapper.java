...
interface WorkOrderQueryMapper {
    List<Map<String,Object>> findPage(@Param("tenantId") String tenantId,
            ...
            @Param("applyTaskStatusFilter") boolean applyTaskStatusFilter,
            @Param("taskStatusWorkOrderIds") List<String> taskStatusWorkOrderIds,
            @Param("applyNetworkFilter") boolean applyNetworkFilter,
            @Param("networkWorkOrderIds") List<String> networkWorkOrderIds,
            @Param("applyNetworkUnassignedFilter") boolean applyNetworkUnassignedFilter,
            @Param("activeNetworkWorkOrderIds") List<String> activeNetworkWorkOrderIds,
