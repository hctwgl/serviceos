...
final class GlobalProblemHandler {
    ...
    ProblemDetail handleBusinessProblem(BusinessProblem exception, HttpServletRequest request) {
        HttpStatus status = switch (exception.code()) {
            ...
            case RESOURCE_NOT_FOUND, PROJECT_FULFILLMENT_PROFILE_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case PROJECT_FULFILLMENT_REVISION_NOT_EFFECTIVE,
                 PROJECT_FULFILLMENT_PROFILE_SUSPENDED,
                 PROJECT_FULFILLMENT_CLIENT_NOT_SUPPORTED -> HttpStatus.UNPROCESSABLE_CONTENT;
