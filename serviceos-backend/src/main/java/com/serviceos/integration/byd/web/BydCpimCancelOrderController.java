...
import com.serviceos.integration.byd.application.BydCpimCancelOrderService;
 ...
 * BYD CPIM 用户取消订单入站端点。
 *
 * <p>使用 CPIM APP_KEY/Nonce/Cur_Time/Sign 协议认证，不使用 OIDC JWT。</p>
 */
@RestController
@RequestMapping("/api/v1/integrations/byd/cpim/v7.3.1/cancel-orders")
final class BydCpimCancelOrderController {
    private final BydCpimCancelOrderService service;

    BydCpimCancelOrderController(BydCpimCancelOrderService service) {
