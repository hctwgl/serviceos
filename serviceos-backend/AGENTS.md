...
| integration | BYD CPIM 入站 Envelope/Canonical、OutboundDelivery/Attempt/Ack、通用入站 SPI 与 `OutboundSubmissionPipeline` | `int_` | api、spi；`byd`/`geely`/`referenceoem` 为模块内 OEM 适配器 |
